# Créer un script principal d'utilisation
...
with open('fraud_detector.py', 'w', encoding='utf-8') as f:
    f.write(script_content)

print("📝 Script principal créé: fraud_detector.py")

# Tester le script
print("\n🧪 Test du script:")
import subprocess
result = subprocess.run(['python', 'fraud_detector.py', '--test'], 
